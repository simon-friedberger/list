...
func ValidateOnline(ctx context.Context, l *List, client *github.GHRepo) (errs []error) {
...
func validateTXTRecords(ctx context.Context, b Block, client *github.GHRepo) (errs []error) {
